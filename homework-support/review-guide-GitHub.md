...
From Class 31 there is a new review process set up to make the students and your lives a little easier. If you are reviewing a class with a number lower than 31, please look at the [PRE-CLASS-31](#pre-class-31) section.
...
If you find an exercise where you see students making the same mistakes that can be caught in a unit test, then please help yourself and the students out by writing one. The students would be helped by getting feedback faster, and the mentors won't have to write the same thing everytime. You can always send a PR to the Homework repository!

## Best practices 
There are five points which we think are essential for good feedback in HackYourFuture.
...
As a rule of thumb we say that a normal review is somewhere between 10 and 15 comments. 
...
3. Click on the GitHub Pull Request icon in the VSCode taskbar and expand the **All** option. As shown in the picture below, you will see a list of the most recent Pull Requests for this repository.
